...
class Person(BaseModel):
    ...
    outside_initiation_by = CharField(
        ...
        blank=True,
        default="",
        verbose_name=_("Initiation by outside gurus"),
    )
    ...
    local_care_coordinator_name = CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_("Name of local care coordinator"),
    )
    local_care_coordinator_mobile = CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_("Mobile number of local care coordinator"),
    )
    local_care_coordinator_email = EmailField(
        blank=True, null=True, verbose_name=_("Email of local care coordinator")
    )
    ...
    national_care_coordinator_name = CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_("Name of national care coordinator"),
    )
    national_care_coordinator_mobile = CharField(
        ...
        blank=True,
        null=True,
        verbose_name=_("Mobile number of national care coordinator"),
    )
    national_care_coordinator_email = EmailField(
        blank=True, null=True, verbose_name=_("Email of national care coordinator")
    )
